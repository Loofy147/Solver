...
def main():
    ...
    if args.solve_aimo:
        print(f"\n{W_}AIMO COMPETITION REFERENCE SOLVER (10/10){Z_}")
        print("─"*72)

        problems = [
            ("0e644e", "Triangle perimeter (Geometry)", AimoSolver.solve_0e644e, 336),
            ("26de63", "Sum-of-divisors valuation (Number Theory)", AimoSolver.solve_26de63, 32951),
            ("424e18", "Tournament order valuation (Combinatorics)", AimoSolver.solve_424e18, 21818),
            ("42d360", "Ken's base representation moves (Algorithm)", AimoSolver.solve_42d360, 32193),
            ("641659", "n-tastic triangle (Geometry)", AimoSolver.solve_641659, 57447),
            ("86e8e5", "n-Norwegian integers (Number Theory)", AimoSolver.solve_86e8e5, 8687),
            ("92ba6a", "Alice and Bob sweets and ages (Algebra)", AimoSolver.solve_92ba6a, 50),
            ...
            ("dd7f5e", "Shifty functions in F (Combinatorics)", AimoSolver.solve_dd7f5e, 160),
        ]
